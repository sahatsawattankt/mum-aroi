...
const AddMenu = async () => {
    ...
    // Append menu images to the form data
    for (const image of menuImages.value) {
        formData.append("menu_images[]", image.raw);
    }
    try {
                    ...
                    >
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-4 py-3">{{ menu.price }} THB</td>
                                <td
                                        ...
                                        >
                                            ...
                                            <li>
                                                <a
                                                    ...
                                                    class="block py-2 px-4 hover:bg-gray-100 hover:cursor-pointer dark:hover:bg-gray-600 dark:hover:text-white"
                                                >
                                                    Edit
                                                </a>
                                            </li>
